...
/*
  ...
  AddTask(){
    this.task=new Task(1,this.taskName, "non_demarre", this.collaboRes, this.startDate, this.startDate, this.endDate, this.endDate, this.description, this.Cestimee,2,2,2,[],[],[]);
